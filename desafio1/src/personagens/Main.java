...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println(guerreiro.getNome() + " recebe " + guerreiro.receberDano(500) + " de dano e fica com "
				+ guerreiro.getPontosDeVida() + " pontos de vida.");
		System.out.println(mago.getNome() + " recebe " + mago.receberDano(500) + " de dano fica com "
				+ mago.getPontosDeVida() + " pontos de vida.");
